			...
			<ul class="nav nav-pills mb-3" id="profileTabs" role="tablist">
				<li class="nav-item" role="presentation">
					<button class="nav-link active" id="tab-profile-btn"
						data-bs-toggle="pill" data-bs-target="#tab-profile" type="button"
						role="tab">Profile Details</button>
				</li>
				<li class="nav-item" role="presentation">
					<button class="nav-link" id="tab-bookings-btn"
						data-bs-toggle="pill" data-bs-target="#tab-bookings" type="button"
						role="tab">My Bookings</button>
				</li>
			</ul>
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="d-flex mb-3 align-items-start">
									...
									%>
									<input type="text" class="form-control input-box profile-field"
										name="full_name" value="<%=p.getFullName()%>" disabled>
									<a class="delete-btn"
									...
									%>
									<span class="add-btn" onclick="enableField('full_name')">+
										Add</span> <input type="text"
										class="form-control input-box d-none add-input"
										id="full_name-input" name="full_name"
								...
								<div class="d-flex mb-3 align-items-start">
									...
									%>
									<input type="text" class="form-control input-box profile-field"
										name="phone" value="<%=p.getPhone()%>" disabled> <a
										class="delete-btn"
									...
									%>
									<span class="add-btn" onclick="enableField('phone')">+
										Add</span> <input type="text"
										class="form-control input-box d-none add-input"
							...
							<div class="col-md-6">
								...
								<div class="d-flex mb-3 align-items-start">
									...
									%>
									<input type="text" class="form-control input-box profile-field"
										name="address" value="<%=p.getAddress()%>" disabled>
									<a class="delete-btn"
									...
									%>
									<span class="add-btn" onclick="enableField('address')">+
										Add</span> <input type="text"
										class="form-control input-box d-none add-input"
								...
								<div class="d-flex mb-3 align-items-start">
									...
									%>
									<input type="text" class="form-control input-box profile-field"
										name="zipcode" value="<%=p.getZipcode()%>" disabled>
									<a class="delete-btn"
									...
									%>
									<span class="add-btn" onclick="enableField('zipcode')">+
										Add</span> <input type="text"
										class="form-control input-box d-none add-input"
							...
							<table class="table table-sm mb-0">
								...
								<tbody>
									...
									<tr>
										...
										<td><span class="badge badge-status <%=cgClass%>"><%=cgLabel%></span>
										</td>
