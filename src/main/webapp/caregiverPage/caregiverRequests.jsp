...
<div class="wrap">
    ...
    <div class="cardx mb-3">
        ...
        <div class="small-note mt-2">
            Accepting a request assigns the service to you.
        </div>
    </div>
            ...
            <table class="table align-middle">
                ...
                %>
                    <tr>
                        ...
                        <td>
                            <form method="post" action="<%=request.getContextPath()%>/caregiver/accept" class="m-0">
                ...
                %>
                    <tr>
                        <td colspan="6" class="text-center text-muted py-4">No open service requests.</td>
                    </tr>
                <%
                    }
                %>
