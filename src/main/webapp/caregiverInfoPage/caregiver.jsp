...
<%
    ...
    try {
        ...
        while (rs.next()) {
            ...
            c.put("photo", rs.getString("photo_url"));
            caregivers.add(c);
        }
        ...
        <% for (Map<String,Object> c : caregivers) { %>
            ...
            <div class="col-md-6">
                <div class="caregiver-card d-flex gap-3 align-items-start">
                    ...
                    <img src="<%= c.get("photo") %>" alt="Caregiver Photo" class="caregiver-photo">

                    <div>
                        <div class="caregiver-name"><%= c.get("name") %></div>

                        <div><span class="caregiver-detail-label">Gender:</span><%= c.get("gender") %></div>
                        <div><span class="caregiver-detail-label">Experience:</span><%= c.get("exp") %> years</div>
                        <div><span class="caregiver-detail-label">Rating:</span>⭐ <%= c.get("rating") %></div>

                        <div class="mt-2">
                            <span class="caregiver-detail-label">About:</span>
                            <span><%= c.get("desc") %></span>
                        </div>
                    </div>
