...
public class NotificationDAO {
	...
	public List<Notification> getLatest(int customerId, int limit) {
		...
		String sql = "SELECT notification_id, customer_id, booking_id, detail_id, title, message, is_read, created_at "
	...
	public List<Notification> getUnreadSince(int customerId, int lastId) {
		List<Notification> list = new ArrayList<>();
		String sql = "SELECT notification_id, booking_id, detail_id, title, message, is_read, created_at "
