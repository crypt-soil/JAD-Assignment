...
import model.Bookings.BookingDetailStatusDAO;
...
public class BookingStatusServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		for (int i = 0; i < statuses.size(); i++) {
			...
			if (i > 0)
				json.append(",");
			json.append("{").append("\"detailId\":").append(s.getDetailId()).append(",").append("\"caregiverStatus\":")
					.append(s.getCaregiverStatus()).append("}");
		}
